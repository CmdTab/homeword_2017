...
<div class="woocommerce-order">
	...
	<?php if ( $order ) : ?>
		...
		<?php else : ?>
			...
			<ul class="woocommerce-order-overview woocommerce-thankyou-order-details order_details order-list thank-you">

				<li class="woocommerce-order-overview__order order group">
					<div class="order-label"><?php _e( 'Order number:', 'woocommerce' ); ?></div>
					<div class="order-amount"><strong><?php echo $order->get_order_number(); ?></strong></div>
				</li>

				<li class="woocommerce-order-overview__date date group">
					<div class="order-label"><?php _e( 'Date:', 'woocommerce' ); ?></div>
					<div class="order-amount"><strong><?php echo wc_format_datetime( $order->get_date_created() ); ?></strong></div>
				</li>

				<li class="woocommerce-order-overview__total total group">
				...
				<?php if ( $order->get_payment_method_title() ) : ?>
					...
					<li class="woocommerce-order-overview__payment-method method group">
						<div class="order-label"><?php _e( 'Payment method:', 'woocommerce' ); ?></div>
						<div class="order-amount"><strong><?php echo wp_kses_post( $order->get_payment_method_title() ); ?></strong></div>
					</li>
